      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
            ...
            <form action="/vigenere/enkripsi" method="POST" role="form" class="php-email-form"> 
              @csrf
              <h3>Encoder</h3>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <div class="box featured" data-aos="zoom-in" data-aos-delay="200">
              <form action="/vigenere/dekripsi" method="POST" role="form" class="php-email-form">
                @csrf
                  <h3>Decoder</h3>
          ...
          <div class="col-lg-6 col-md-6 mt-4 mt-lg-0">
            <div class="box featured" data-aos="zoom-in" data-aos-delay="200">
              ...
              <table class="table">
                  ...
                  <tbody>
                    @foreach ($tampil_vigenere as $his)
                      <tr>
                        <td align="center">
                        {{$his->plain}}
                        </td>
